...
class Selecttrio extends Component
{

    public $attributeSet, $picks, $selected, $placeholder, $name, $tableName, $showHidden, $connection, $isGrouped, $childKey, $label, $grid, $api, $uuid;
    ...
    {
        return view('layout::components.data-entry.selecttrio');
    }
}
