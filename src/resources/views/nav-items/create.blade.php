<x-theme-master>
    ...
    <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
            <form action="{{ route('nav-items.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="text" id="urlInput" name="url" :value="old('url')"  class="form-control text-dark ps-5 h-55" placeholder="Enter Url">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="text" id="labelInput" name="label" :value="old('label')"  class="form-control text-dark ps-5 h-55" placeholder="Enter Label">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="text" id="tooltipInput" name="tooltip" :value="old('tooltip')"  class="form-control text-dark ps-5 h-55" placeholder="Enter Toltip">
                            </div>
                        </div>
                    </div>
