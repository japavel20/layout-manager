<x-theme-master>
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
        <h3 class="mb-0">Nav Group Edit</h3>
    ...
    <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
            <form action="{{ route('nav-groups.update', $navGroup->uuid) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="text" id="titleInput" name="title" value="{{ old('title', $navGroup->title ?? '') }}"  class="form-control text-dark ps-5 h-55" placeholder="Enter Title">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="text" id="iconInput" name="icon" value="{{ old('icon', $navGroup->icon ?? '')}}"  class="form-control text-dark ps-5 h-55" placeholder="Enter Icon Class">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="number" id="positionInput" name="position" value="{{ old('position', $navGroup->position ?? '')}}"  class="form-control text-dark ps-5 h-55" placeholder="Enter Position No">
                            </div>
                        </div>
                    </div>
