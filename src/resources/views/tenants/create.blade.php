                    ...
                    <div class="col-lg-3">
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="text" id="nameInput" name="name" :value="old('name')"  class="form-control text-dark ps-5 h-55" placeholder="Enter Tenant Name" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="text" id="domainInput" name="domain" :value="old('url')"  class="form-control text-dark ps-5 h-55" placeholder="e.g: http://xyz.com/">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="text" id="databaseInput" name="database" :value="old('database')"  class="form-control text-dark ps-5 h-55" placeholder="Enter Database Name">
                            </div>
                        </div>
                    </div>
