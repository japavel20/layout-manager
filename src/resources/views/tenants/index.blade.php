    ...
    <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-lg-4 mb-3">
                ...
                <a href="{{route('tenants.create')}}" class="btn btn-outline-primary py-1 px-2 px-sm-4 fs-14 fw-medium rounded-3 hover-bg">
                    <span class="py-sm-1 d-block">
                        <i class="ri-add-line d-none d-sm-inline-block fs-18"></i>
                        <span>Add New Tenat</span>
                    </span>
                </a>
            </div> 
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-1">
                                            <button class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
                                                <a href="{{route('tenants.show', $tenant->id)}}"><i class="material-symbols-outlined fs-16 text-primary">visibility</i></a>
                                            </button>
                                            <button class="ps-0 border-0 bg-transparent lh-1 position-relative top-2">
                ...
                <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap">
                    ...
                    <div class="d-flex align-items-center">
                        <span class="fs-13 fw-medium me-2">
                            {{ $tenants->firstItem() }} - {{ $tenants->lastItem() }} of {{ $tenants->total() }}
                        </span>
                        {{ $tenants->appends(['per_page' => request('per_page', 10)])->links('pagination::bootstrap-5') }}
                    </div>
                </div>
            </div>
        </div>
